      ...
      <div className="container-responsive">
        <div className="flex flex-col gap-12 lg:flex-row lg:gap-16">
          ...
          <div className="flex-1">
            <h2 className="text-3xl font-bold text-[#111827] md:text-4xl lg:text-5xl mb-6">
              Como Pode Ajudar?
            </h2>
          ...
          <div className="flex-1 bg-white/80 rounded-[20px] p-8 md:p-12 shadow-xl backdrop-blur-sm">
            <h3 className="text-2xl font-bold text-[#111827] mb-8 text-center">
              Meta de Arrecadação
            </h3>
            <div className="relative h-[400px] flex items-end justify-center gap-4">
              ...
              <div className="w-32 bg-[#B496C8] rounded-t-lg" style={{height: '40%'}}>
                <div className="text-center text-white text-sm pt-2">15,000 €</div>
              </div>
              <div className="w-32 bg-gray-200 rounded-t-lg h-full flex items-center justify-center">
                <div className="text-center text-gray-600 text-sm">40,000 €</div>
              </div>
            </div>
          </div>
        </div>
